...
import com.bardaval.recipesapp.databinding.ActivitySearchBinding

class SearchActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySearchBinding
    private lateinit var recyclerViewAdapter: SearchAdpater
    ...
    private fun setUpRecyclerView() {
        ...
        recyclerViewAdapter = SearchAdpater(dataList, this)
